...
const u8 gText_ExpShareTurnOn[] = _("Turned on the Exp. Share.\pParty will now gain some\nof the Experience Points.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareTurnOff[] = _("Turned off the Exp. Share.\pParty will no longer gain\n any Experience Points.{PAUSE_UNTIL_PRESS}");
